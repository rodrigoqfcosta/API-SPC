...
3ª Sprint|- Configuração do banco de dados MongoDB.<br> - Construção do Backend em Python.<br> - Configuração da API Google Maps Places.<br> - Mapeamento de condenadas, segmentação regional (IA).<br> - Segmentação do porte financeiro (IA).<br> - Mapeamento do tipo de pessoa física ou jurídica (IA).<br> |26/04 - 16/05
